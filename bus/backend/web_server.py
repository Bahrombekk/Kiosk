...
WEB_DOMAIN = os.environ.get("KIOSK_WEB_DOMAIN", "avtobus.uz")
...
def _default_web_dir():
    ...
    if getattr(sys, "frozen", False):
        ...
        return None
    # backend/ -> bus/ -> bus/web
    bus_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    d = os.path.join(bus_root, "web")
