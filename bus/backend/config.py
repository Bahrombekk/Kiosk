...
# moslashadi. "train" = poyezd (asl). Kelajakда: "cafe", "market" ...
VERTICAL = os.environ.get("KIOSK_VERTICAL", "bus").strip().lower() or "bus"

# LAN beacon (kiosklar serverni topishi uchun). Avtobusда kiosk yo'q — veb'da
# yo'lovchi telefonда ishlaydi, shuning uchun standart O'CHIQ.
DISCOVERY_ENABLED = os.environ.get("KIOSK_DISCOVERY",
                                   "0" if VERTICAL == "bus" else "1") == "1"
