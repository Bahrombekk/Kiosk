...
def hardware_id():
    ...
    `KIOSK_HW_ID` env berilsa — o'sha ishlatiladi. Bu bitta mashinada bir nechta
    vertikal/nusxa (masalan poyezd + avtobus test) alohida qurilma sifatida
    bulutga ulanishi uchun kerak (aks holda bir xil MachineGuid → bir server_id)."""
    forced = os.environ.get("KIOSK_HW_ID")
