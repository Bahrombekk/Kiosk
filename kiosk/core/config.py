...
# (server bilan bir xil `pbkdf2$iter$salt$hash` format). Xesh yaratish:
#   python -c "from core import pinhash; print(pinhash.hash_secret('PIN'))"
# STANDART: 7777 ning xeshi singdirilgan — frozen (buld) da ham ishlaydi.
# Xesh (ochiq matn emas) — `strings` bilan exe'dan PIN chiqarib bo'lmaydi.
# Boshqa PIN kerak bo'lsa KIOSK_DEV_PIN_HASH bilan almashtiriladi.
DEV_EXIT_PIN_HASH = os.environ.get(
    "KIOSK_DEV_PIN_HASH",
    "pbkdf2$100000$d5a4a0e7805e03cb0091ac39bf15f2a0$"
    "dc05f01ac27a1c355317d768f59b274b663b6bdaca9972e4b3e98a2cdaa15303")
