...
Poyezd kiosk tizimining **veb versiyasi** (Nuxt 4 SPA). Bu ilova [PyQt6 kiosk
ilovasi](../kiosk/)ning brauzerdagi muqobili: bir xil 5 bo'lim (Asosiy, Videolar,
...
`maplibre-gl` + `pmtiles` (oflayn xarita) · `@nuxtjs/color-mode` (light/dark) · `nuxt-svgo`.
...
> To'liq qulflangan poyezd kioski uchun [../kiosk/](../kiosk/) ilovasi ishlatiladi.
